...
int main(int argc, char* argv[])
{
    ...
    while (!is_quit)
    {
        ...
        while (SDL_PollEvent(&g_event) != 0)
        {
            ...
            p_player.HandleImputAction(g_event, g_screen);
        }
        SDL_SetRenderDrawColor(g_screen, RENDER_DRAW_COLOR, RENDER_DRAW_COLOR, RENDER_DRAW_COLOR, RENDER_DRAW_COLOR);
            ...
            if (p_threat != NULL)
            {
                ...
                if (bCol1)
                {
                    ...
                    if (num_die <= 4)
                    {
                        ...
                        SDL_Delay(1000);
                        player_stat.Decrease();
                        player_stat.Render(g_screen);
                        continue;
                    }
                    else
                    {
        ...
        int real_imp_time = fps_timer.get_ticked(); //make sure one frame run in 1/25 second
